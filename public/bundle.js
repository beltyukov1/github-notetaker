...
/***/ function(module, exports, __webpack_require__) {
	...
	var Profile = React.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    this.ref = new Firebase('https://gh-react-notetaker2.firebaseIO.com');
	    this.init();
	  },
	  componentWillUnmount: function componentWillUnmount() {
	    this.unbind('notes');
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.bio.followers !== null && React.createElement(
	          "li",
	          { className: "list-group-item" },
	          "Followers: ",
	          this.props.bio.followers
	        ),
	        this.props.bio.following !== null && React.createElement(
	          "li",
	          { className: "list-group-item" },
	          "Following: ",
	          this.props.bio.following
	        ),
	        this.props.bio.public_repos !== null && React.createElement(
	          "li",
	          { className: "list-group-item" },
	          "Public Repos: ",
